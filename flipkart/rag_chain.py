    ...
    def build_rag_chain(self):
        ...
        context_prompt = ChatPromptTemplate.from_messages(
            [
                (
                    "system",
                    """Given the chat history and user question, rewrite the user question to be more specific and contextually relevant to the question""",
                ),
                MessagesPlaceholder(
        ...
        qa_prompt = ChatPromptTemplate.from_messages(
            [
                (
                    "system",
                    """You are an e-commerce bot answering product related queries using reviews and titles from the product reviews database.
